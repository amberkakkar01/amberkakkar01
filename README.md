...
Experienced developer focused on scalable backend systems, distributed systems, and end-to-end API design. I work with Golang and Java and enjoy building reliable distributed services and data-driven applications.
...
- 🔭 Building highly scalable microservices using Golang and Java
- 🌱 Passionate about Distributed Systems and Cloud-native design
- 💬 Ask me about End-to-End API development, agentic systems, Machine Learning pipelines, Web & Flutter apps

- 🤖 Agentic & automation highlights: designed agentic workflows for task orchestration, autonomous monitoring, and lightweight decision agents (can provide examples on request)
...
- Microservices, RESTful APIs, gRPC, API design

Databases & Data:

- MySQL, PostgreSQL, basic NoSQL, data pipelines, scikit-learn

Cloud & DevOps:

- Docker, CI/CD, Git, basic cloud deployment (can expand with AWS/GCP details)

Frameworks & Tools:

- Spring, Gin (Go), Flask/FastAPI, Flutter, Bootstrap, Git
...
## Tech Stack
<p align="left">
  <img src="https://raw.githubusercontent.com/gilbarbara/logos/c122ccfcfdb15d9958a85696ff2460ac3b01f8ca/logos/java.svg" alt="java" width="40" height="40"/>
  <img src="https://go.dev/blog/go-brand/Go-Logo/SVG/Go-Logo_Blue.svg" alt="go" width="45" height="45"/>
  ...
  <img src="https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/scikitlearn.svg" alt="scikit-learn" width="60" height="40"/> 
